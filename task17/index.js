...
class School {
  ...
  const nycSchoolCatalog = new SchoolCatalog();
  nycSchoolCatalog.addSchool(lorraineHansbury);
  nycSchoolCatalog.addSchool(alSmith);
  
  console.log(nycSchoolCatalog.schools);
